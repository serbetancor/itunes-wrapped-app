<template>
  <div
    class="transition-color flex min-h-screen flex-col bg-white text-zinc-700 duration-600 dark:bg-zinc-700 dark:text-white"
  >
    <template v-if="getRouter().currentRoute.value.name !== 'wrapped'">
      <button
